...
#pragma region JR
		...
		setEightBitInstruction(0x18, JR, s8);
		setEightBitInstruction(0x28, JR, Z);
		setEightBitInstruction(0x38, JR, C);
		setEightBitInstruction(0x20, JR, NZ);
		setEightBitInstruction(0x30, JR, NC);

#pragma endregion

#pragma region JP

		setEightBitInstruction(0xC2, JP, NZ);
		setEightBitInstruction(0xD2, JP, NC);
		setEightBitInstruction(0xC3, JP, a16);
		setEightBitInstruction(0xE9, JP, HL);
		setEightBitInstruction(0xCA, JP, Z);
		setEightBitInstruction(0xDA, JP, C);

#pragma endregion

#pragma region CALL

		setEightBitInstruction(0xC4, CALL, NZ);
		setEightBitInstruction(0xD4, CALL, NC);
		setEightBitInstruction(0xCD, CALL, a16);
		setEightBitInstruction(0xCC, CALL, Z);
		setEightBitInstruction(0xDC, CALL, C);
...
#pragma region EI
		...
		setEightBitInstruction(0xFB, EI);

#pragma endregion

#pragma region DI

		setEightBitInstruction(0xF3, DI);

#pragma endregion

#pragma region RST

		setEightBitInstruction(0xC7, RST, (ArithmeticTarget)0);
		setEightBitInstruction(0xCF, RST, (ArithmeticTarget)1);
		setEightBitInstruction(0xD7, RST, (ArithmeticTarget)2);
		setEightBitInstruction(0xDF, RST, (ArithmeticTarget)3);
		setEightBitInstruction(0xE7, RST, (ArithmeticTarget)4);
		setEightBitInstruction(0xEF, RST, (ArithmeticTarget)5);
		setEightBitInstruction(0xF7, RST, (ArithmeticTarget)6);
		setEightBitInstruction(0xFF, RST, (ArithmeticTarget)7);

#pragma endregion

#pragma region RETI

		setEightBitInstruction(0xD9, RETI);

#pragma endregion

#pragma region RLCA

		setEightBitInstruction(0x07, RLCA);

#pragma endregion

#pragma region RLA

		setEightBitInstruction(0x17, RLA);

#pragma endregion

#pragma region RRCA

		setEightBitInstruction(0x0F, RRCA);

#pragma endregion

#pragma region RRA

		setEightBitInstruction(0x1F, RRA);
...
#pragma region prefixed instructions
	...
	#pragma region SLA
		...
		for (int t = 0; t < 8; t++) {
			setPrefixedInstruction(0x20 + t, SLA, targets[t]);
		}
	...
	#pragma region SRA
		...
		for (int t = 0; t < 8; t++) {
			setPrefixedInstruction(0x28 + t, SRA, targets[t]);
		}
	...
	#pragma region RL
		...
		for (int t = 0; t < 8; t++) {
			setPrefixedInstruction(0x10 +t, RL, targets[t]);
		}
